Scheduler.plugin(function (e) {
  ;(e._temp_matrix_scope = function () {
    ...
    function r(t, n) {
      function r(e, t, a, n) {
        e[t] || (e[t] = [])
        for (var i = a; i <= n; i++) e[t][i] || (e[t][i] = []), e[t][i].push(h)
      }
      ...
      for (var c = n.y_property, _ = 0; _ < t.length; _++) {
        ...
        if (l && f && f.$parent)
          for (var m = {}; f.$parent; ) {
            if (m[f.key])
              throw new Error(
                "Invalid sections tree. Section `{key:'" +
                  f.key +
                  "', label:'" +
                  f.label +
    ...
    function d(t, a) {
      ...
      return (
        a.scrollable || (n = e.$container.querySelector('.dhx_cal_data')), n
      )
    }
    function s(e) {
      ...
      if (
        ...
        (h.addEventListener
          ? 'onwheel' in document
            ...
            : 'onmousewheel' in document && h.addEventListener('mousewheel', r)
          ...
          if (
            ...
            if (
              ((u !== a._x_scroll || a._is_ev_creating) &&
                (a.second_scale
                  ? e._timeline_smart_render.updateHeader(a, v, c.children[1])
                  : e._timeline_smart_render.updateHeader(a, v, c.children[0])),
              e.config.rtl)
            ) {
              var m = +e.$container
                  .querySelector('.dhx_timeline_label_wrapper')
                  .style.height.replace('px', ''),
                p =
                  a._section_height[a.y_unit.length] +
                  a._label_rows[a._label_rows.length - 1].top
              a.scrollHelper.getMode() == a.scrollHelper.modes.minMax &&
              (p > m || 'tree' == a.render)
                ? (c.style.right = -1 - u - o() + 'px')
                : (c.style.right = -1 - u + 'px'),
                (c.style.left = 'unset')
            } else c.style.left = -1 - u + 'px'
            ;(a._options_changed || h !== a._y_scroll || a._is_ev_creating) &&
            ...
            x =
              'cell' === a.render
                ...
                : s.querySelectorAll('.dhx_timeline_data_col .dhx_matrix_line')
            ...
            e.$container.querySelector('.dhx_timeline_data_col').style.height =
              b + 'px'
            var S = s.scrollTop,
              N = a.scrollHelper.getScrollValue(s),
              M =
                a._summ -
                e.$container.querySelector('.dhx_cal_data').offsetWidth +
                a.dx +
          ...
          _.addEventListener('touchmove', function (t) {
            ...
            if (
              ...
              h < 0.42 ? (r = 0) : u < 0.42 && (o = 0),
                ...
                (_.scrollTop += o),
                a.scrollable && o && (i.style.top = -_.scrollTop + 'px')
            }
    ...
    function h(e, t) {
      ...
      if (e.matches || e.msMatchesSelector || e.webkitMatchesSelector) {
        ...
        do {
          if (
            (a.matches || a.msMatchesSelector || a.webkitMatchesSelector).call(
              a,
              t,
            )
          )
    ...
    function v(t) {
      if (!e.getState().drag_id) return clearInterval(M), void (A = null)
      ...
      if (a) {
        var n = e._schedulerOuter,
          ...
          d = i.y,
          s = a.autoscroll || {}
        e._merge(s, { range_x: 200, range_y: 100, speed_x: 20, speed_y: 10 })
        var l = f(_, r, A ? A.x : 0, s.range_x)
        a.scrollable || (l = 0)
        var c = f(d, o, A ? A.y : 0, s.range_y)
        ;(!c && !l) || A || ((A = { x: _, y: d }), (l = 0), (c = 0)),
          (l *= s.speed_x),
          (c *= s.speed_y),
          l &&
            c &&
          ...
          l || c ? ((A.started = !0), m(l, c)) : clearInterval(M)
      }
    }
    function f(e, t, a, n) {
      return e < n && (!A || A.started || e < a)
        ? -1
        : t - e < n && (!A || A.started || e > a)
        ? 1
        : 0
    }
    function m(t, a) {
    ...
    var p = (function () {
      return function () {
        ...
        function t() {
          ...
          return (
            ...
            a.scrollLeft > 0
              ? (t = _.minMax)
              : ((a.scrollLeft = -50),
                (t = -50 === a.scrollLeft ? _.nMaxMin : _.maxMin)),
        ...
        var o,
          _ = { minMax: '[0;max]', maxMin: '[max;0]', nMaxMin: '[-max;0]' }
        return {
          modes: _,
          getMode: r,
          normalizeValue: a,
    ...
    ;(e.matrix = {}),
      ...
      (e.createTimelineView = function (a) {
            ...
            _logic: function (t, a, n) {
              ...
              return (
                e.checkEvent('onBeforeSectionRender') &&
                  (i = e.callEvent('onBeforeSectionRender', [t, a, n])),
                i
              )
            },
          }),
        ...
        ;(e.render_data = function (t, n) {
          ...
          (e.templates[a.name + '_row_class'] = function (e, t) {
            return t.folder_events_available && e.children ? 'folder' : ''
          }),
          ...
          (e.templates[a.name + '_date'] = function (t, a) {
            return (t.getDay() == a.getDay() && a - t < 864e5) ||
              ...
              ? e.templates.day_date(t) + ' &ndash; ' + e.templates.day_date(a)
              : e.templates.week_date(t, a)
          }),
          (e.templates[a.name + '_scale_date'] = e.date.date_to_str(
            a.x_date || e.config.hour_date,
          )),
          (e.templates[a.name + '_second_scale_date'] = e.date.date_to_str(
          ...
          (a._smartRenderingEnabled = function () {
            var t = null
            ;(this.scrollable || this.smart_rendering) &&
              (t = e._timeline_smart_render.getViewPort(
                this.scrollHelper,
                this._sch_height,
              ))
            var a = !!t
            return !!(this.scrollable
              ? !1 !== this.smart_rendering && !!a
              : !!this.smart_rendering && a)
          }),
          (a.scrollTo = e.bind(function (t) {
            if (t) {
              ...
              var i
              if (
                ((i = 'number' == typeof a ? a : this.posFromDate(a)),
                e.config.rtl)
              ) {
                var r = +e.$container
                    .querySelector('.dhx_timeline_label_wrapper')
                    .style.height.replace('px', ''),
                  _ =
                    this._section_height[this.y_unit.length] +
                    this._label_rows[this._label_rows.length - 1].top
                this.scrollHelper.getMode() == this.scrollHelper.modes.minMax &&
                  (_ > r || 'tree' == this.render) &&
                  (i -= o())
              }
              var d = e.$container.querySelector('.dhx_timeline_data_wrapper')
              this.scrollable ||
                (d = e.$container.querySelector('.dhx_cal_data')),
                this.scrollable && this.scrollHelper.setScrollValue(d, i),
                n > 0 && (d.scrollTop = n)
            }
          }, a)),
          ...
          (a.dateFromPos = function (t) {
            return e._timeline_drag_date(a, t)
          }),
          (a.sectionFromPos = function (t) {
            var n = { y: t }
            return e._resolve_timeline_section(a, n), n.section
          }),
          (a.resolvePosition = function (e) {
            var t = { date: null, section: null }
            return (
              e.left && (t.date = a.dateFromPos(e.left)),
              e.top && (t.section = a.sectionFromPos(e.top)),
              t
            )
          }),
        ...
        e['mouse_' + a.name] = function (t) {
          ...
          if (
            ...
            if (
              ((t.converted = 1), (t.x += -a.dx + a._x_scroll), e.config.rtl)
            ) {
              var i = +e.$container
                  .querySelector('.dhx_timeline_label_wrapper')
                  .style.height.replace('px', ''),
            ...
            t.y += a._y_scroll
          } else e.config.rtl ? (t.x -= a.dx - e.xy.scale_width) : (t.x -= a.dx)
          ...
          if (
            ...
            if (
              ...
              var s =
                (d._event_length,
                this._get_fictional_event_length(_, d._move_delta, a, !0))
              _ = new Date(_ - s)
          ...
          if (
            ...
            switch (this._drag_mode) {
              case 'move':
                this.config.preserve_length ||
                  ((_ = e._timeline_get_rounded_date.call(a, _, !1)),
                  'day' == a.x_unit && (t.custom = !1))
                break
              case 'resize':
                this._drag_event &&
                  ((null !== this._drag_event._resize_from_start &&
                    void 0 !== this._drag_event._resize_from_start) ||
                    (this._drag_event._resize_from_start = t.resize_from_start),
          ...
          this._resolve_timeline_section(a, t),
            ...
            a.round_position &&
              ...
              _ <= this._drag_start &&
              (t.shift =
                e.date.add(this._drag_start, a.x_step, a.x_unit) -
                this._drag_start)
          var l = this._is_pos_changed(this._drag_pos, t)
          return (
            this._drag_pos && l && (this._drag_event._dhx_changed = !0),
      ...
      (e._get_timeline_event_height = function (e, t) {
        ...
        return (
          'full' == t.event_dy &&
            (n = t.section_autoheight ? t._section_height[a] - 6 : t.dy - 3),
          t.resize_events &&
            (n = Math.max(Math.floor(n / (e._count || 1)), t.event_min_dy)),
          n
        )
      }),
    ...
    ;(e._timeline_trace_events = function () {
            ...
            : ((s = d - h),
              n.first_hour || n.last_hour
                ? ((s -= n._start_correction),
                  s < 0 && (s = 0),
                  (_ = Math.round(s / r)) > e._cols[l] && (_ = e._cols[l]))
                : (_ = Math.round(s / r)))
        }
      ...
      (e._timeline_get_rounded_date = function (t, a) {
        ...
        return (
          a &&
            ...
            (i = this._trace_x[n + 1]
              ? this._trace_x[n + 1]
              : e.date.add(this._trace_x[n], this.x_step, this.x_unit)),
          new Date(i)
        )
      }),
        ...
        if (t && 'cell' != this.render) {
          ...
          for (var a = [], n = t.length, i = -1, r = null, o = 0; o < n; o++) {
            ...
            var d = this.round_position
              ? e._timeline_get_rounded_date.apply(this, [_.start_date, !1])
              : _.start_date
            for (
              this.round_position
                ? e._timeline_get_rounded_date.apply(this, [_.end_date, !0])
                : _.end_date;
              a.length;

            ) {
              if (!(a[a.length - 1].end_date.valueOf() <= d.valueOf())) break
            ...
            if ((a.length && (a[a.length - 1]._inner = !0), !s))
              if (a.length)
                if (a.length <= a[a.length - 1]._sorder) {
                  ...
                  ;(_._sorder = v + 1),
                    i < _._sorder && ((i = _._sorder), (r = _)),
                    (_._inner = !1)
                }
              else _._sorder = 0
            a.push(_),
              a.length > (a.max_count || 0)
                ? ((a.max_count = a.length), (_._count = a.length))
      ...
      (e._timeline_get_block_stats = function (t, a) {
        ...
        return (
          ...
          (n.style_data_wrapper =
            (e.config.rtl ? 'padding-right:' : 'padding-left:') + a.dx + 'px;'),
          (n.style_label_wrapper = 'width: ' + a.dx + 'px;'),
          a.scrollable
            ? ((n.style_data_wrapper +=
                'height:' + (a._sch_height - 1) + 'px;'),
              void 0 === a.html_scroll_width && (a.html_scroll_width = o()),
      ...
      (e._timeline_get_fit_events_stats = function (e, t, a) {
        if (e.fit_events) {
          ...
          ;(a.height = n > a.height ? n : a.height),
            ...
            (a.style_line_height = 'line-height:' + (a.height - 1) + 'px;'),
      ...
      (e._timeline_get_html_for_bar_data_row = function (e, t) {
        ...
        return (
          t.template && (a += ' ' + (t.template(t.section, t.view) || '')),
          "<div class='dhx_timeline_data_row " +
            a +
            "' style='" +
            e.summ_width +
      ...
      (e._timeline_get_html_for_bar = function (t, a, n, i, r, o) {
        var d = _(n._trace_x[t]),
          ...
          l = ''
        n.cell_template &&
          (l = e.templates[n.name + '_cell_value'](i, n._trace_x[t], s, o))
        var c = 'line-height:' + n._section_height[s.key] + 'px;'
        return (
          "<div class='dhx_matrix_cell dhx_timeline_data_cell " +
          e.templates[n.name + '_cell_class'](i, n._trace_x[t], s, o) +
          "' style='width:" +
          e._cols[t] +
          'px; ' +
          (e.config.rtl ? 'right:' : 'left:') +
      ...
      (e._timeline_render_scale_header = function (t, a) {
        ...
        if ((n && n.parentNode.removeChild(n), a)) {
          ...
          ;(n.className = i),
            ...
            (n.innerHTML = e.locale.labels[t.name + '_scale_header'] || ''),
      ...
      (e._timeline_y_scale = function (t) {
        ...
        for (
          var p = !!m, b = this._smartRenderingEnabled(), x = [], w = 0, k = 0;
          k < this.y_unit.length;
          k++
        ) {
        ...
        m && w < m.scrollTop && (m.scrollTop = Math.max(0, w - m.height))
        for (var k = 0; k < this.y_unit.length; k++) {
          var D = x[k],
            ...
            S =
              ...
              D.height +
              "px;' " +
              e._waiAria.label(D.td_content) +
              '>' +
              D.td_content +
              '</div></div>'
          if (
            (b && this._label_rows.push({ div: S, top: f, section: E }),
            b &&
              (e._timeline_smart_render.isInYViewPort(
                { top: f, bottom: f + D.height },
                m,
              ) ||
                (v = !0)),
            (f += D.height),
            ...
            ;(r += S),
              b && e._timeline_smart_render._rendered_labels_cache.push(k)
            var N = e.templates[this.name + '_row_class'],
              M = { view: this, section: E, template: N },
              A = 0
            if ('cell' == this.render) {
              ...
              for (var C = 0; C < e._cols.length; C++)
                e._ignores[C] && !b
                  ? (o += e._timeline_get_html_for_cell_ignores(D))
                  : b && p
                  ? e._timeline_smart_render.isInXViewPort(
                      { left: A, right: A + e._cols[C] },
                      m,
                    ) &&
              ...
              b &&
                p &&
                (O = e._timeline_smart_render.getVisibleEventsForRow(
                  this,
                  m,
                  _,
                  k,
                ))
              ;(o += e._timeline_get_events_html.call(this, O)),
                (o += e._timeline_get_html_for_bar_data_row(D, M))
              for (var C = 0; C < e._cols.length; C++)
                e._ignores[C]
                  ...
                  ? e._timeline_smart_render.isInXViewPort(
                    ...
                    (o += e._timeline_get_html_for_bar(C, k, this, _[k], A))
                  : (o += e._timeline_get_html_for_bar(C, k, this, _[k], A)),
                  (A += e._cols[C])
              o += '</div></div>'
            }
          ...
          if (r.scrollable) {
            ...
            ;(r._x_scroll = r._y_scroll = 0),
              e.$container.querySelector('.dhx_timeline_scrollable_data') &&
                e._timeline_set_scroll_pos(e._els.dhx_cal_data[0], r)
          }
        }
        return !0
      }),
      ...
      (e._timeline_x_scale = function (t) {
        ...
        var i = e.config.preserve_scale_length,
          r = e._timeline_x_dates.call(this, i),
          o = e._x - this.dx - e.xy.scroll_width
        if (this.scrollable && this.column_width > 0) {
          var d = this.column_width * r.displayed
          d > o && ((o = d), (this._section_autowidth = !1))
        }
        var s = [this.dx]
        e._els.dhx_cal_header[0].style.width = s[0] + o + 'px'
        for (
          var l = (e._min_date_timeline = e._min_date),
            c = r.displayed,
            h = r.total,
            u = 0;
          u < h;
        ...
        if (((t.innerHTML = '<div></div>'), this.second_scale)) {
          ...
          for (var D = 0; D < v.length; D++) {
            var E = v[D],
              ...
              N = document.createElement('div')
            ;(N.className =
              'dhx_scale_bar dhx_second_scale_bar' + (S ? ' ' + S : '')),
              e.set_xy(N, f[D] - 1, n - 3, m[D], 0),
              (N.innerHTML = e.templates[this.name + '_second_scale_date'](E)),
              w.appendChild(N)
          }
        }
        ...
        for (var M = 0; M < this._trace_x.length; M++)
          if (!e._ignores[M]) {
            ;(l = this._trace_x[M]), e._render_x_header(M, s[M], l, t)
            var A = e.templates[this.name + '_scalex_class'](l)
            A && (t.lastChild.className += ' ' + A),
              t.lastChild.setAttribute('data-col-id', M),
              t.lastChild.setAttribute('data-col-date', _(l))
            var C = t.lastChild.cloneNode(!0)
            this._h_cols[M] = { div: C, left: s[M] }
          }
        e.xy.scale_height = a
        var O = this._trace_x
        ;(t.onclick = function (t) {
          var a = e._timeline_locate_hcell(t)
          a && e.callEvent('onXScaleClick', [a.x, O[a.x], t || event])
        }),
          (t.ondblclick = function (t) {
            var a = e._timeline_locate_hcell(t)
            a && e.callEvent('onXScaleDblClick', [a.x, O[a.x], t || event])
          })
      }),
      (e._timeline_is_new_interval = function (t, a, n) {
        switch (t) {
          ...
          case 'month':
            return !(
              a.getMonth() == n.getMonth() && a.getFullYear() == n.getFullYear()
            )
          case 'year':
      ...
      (e._timeline_set_full_view = function (t) {
        if ((e._timeline_reset_scale_height.call(this, t), t)) {
          ...
          var a = e._min_date
          if (
            (e._timeline_x_scale.call(this, e._els.dhx_cal_header[0]),
            e.$container.querySelector('.dhx_timeline_scrollable_data'))
          ) {
      ...
      (e._timeline_hideToolTip = function () {
        e._tooltip &&
          ((e._tooltip.style.display = 'none'), (e._tooltip.date = ''))
      }),
      (e._timeline_showToolTip = function (t, a, n) {
        if ('cell' == t.render) {
          ...
          for (var _ = '', d = 0; d < r.length; d++) {
            ...
            ;(_ +=
              ...
              (_ +=
                ...
                (r[d]._timed ? e.templates.event_date(r[d].start_date) : '') +
                '</div>'),
              (_ += "<div class='dhx_event_icon icon_details'>&nbsp;</div>"),
              (_ +=
          ...
          ;(e._tooltip.style.display = ''),
            ...
            (e.config.rtl && n.left - e._tooltip.offsetWidth >= 0) ||
            document.body.offsetWidth -
              a.src.offsetWidth -
              n.left -
              e._tooltip.offsetWidth <
              0
              ? (e._tooltip.style.left = n.left - e._tooltip.offsetWidth + 'px')
              : (e._tooltip.style.left = n.left + a.src.offsetWidth + 'px'),
            (e._tooltip.date = i),
            (e._tooltip.innerHTML = _),
            document.body.offsetHeight - n.top - e._tooltip.offsetHeight < 0
              ? (e._tooltip.style.top =
                  n.top - e._tooltip.offsetHeight + a.src.offsetHeight + 'px')
      ...
      (e._set_timeline_dates = function (t) {
        ;(e._min_date = e.date[t.name + '_start'](new Date(e._date))),
          ...
          e.date[t.x_unit + '_start'] &&
            (e._max_date = e.date[t.x_unit + '_start'](e._max_date)),
          (e._table_view = !0)
      }),
      ...
      (e._timeline_html_index = function (t) {
        ...
        var r = n
        if (e._ignores_detected)
          for (var o in e._ignores) e._ignores[o] && 1 * o <= r && r++
        return r
      }),
      ...
      (e._locate_cell_timeline = function (t) {
        ...
        if (i.scrollable && 'cell' === i.render) {
          ...
          if (c > 0) {
            for (
              ...
              g < i._trace_x.length - 1 && !(+u < i._trace_x[g + 1]);
              g++
            );
            s = g
          }
        ...
        n.src = i._scales[r.section]
          ? i._scales[r.section].querySelectorAll('.dhx_matrix_cell')[d - s]
          : null
        var v = !1,
    ...
    ;(e._click.dhx_marked_timespan = e._click.dhx_cal_data = function (t) {
      ...
      if (n) {
        ...
        i &&
          (i.scale
            ? e.callEvent('onYScaleClick', [i.y, n.y_unit[i.y], t || event])
            : (e.callEvent('onCellClick', [
              ...
              e._timeline_set_scroll_pos(e._els.dhx_cal_data[0], n)))
      }
      return a
    }),
    ...
    var w = e.dblclick_dhx_marked_timespan || function () {}
      ...
      e.attachEvent('onCellDblClick', function (t, a, n, i, r) {
        if (
          ...
          ;(_.start_date = o._trace_x[t]),
            ...
            o._start_correction &&
              (_.start_date = new Date(1 * _.start_date + o._start_correction)),
            o._end_correction &&
              (_.end_date = new Date(_.end_date - o._end_correction)),
    ...
    var k = e._render_marked_timespan
    e._render_marked_timespan = function (t, a, n, i, r) {
      ...
      if (e.matrix && e.matrix[e._mode]) {
        ...
        if (n) (s = [a]), (d = [n])
          ...
          var c = o.order
          if (l) c.hasOwnProperty(l) && (d.push(l), s.push(o._scales[l]))
          else if (o._scales)
            for (var h in c)
              c.hasOwnProperty(h) &&
                o._scales[h] &&
        ...
        if (
          (i.valueOf() < e._min_date.valueOf() && (i = new Date(e._min_date)),
        ...
        for (
          var u = 0;
          u < o._trace_x.length && !e._is_column_visible(o._trace_x[u]);
          u++
        );
        ...
        for (
          ...
          for (var u = 0; u < g.length; u++)
            for (var y = g[u], b = 0; b < f.length; b += 2) {
              var x = f[b],
                w = f[b + 1],
                D = new Date(+y + 60 * x * 1e3),
                E = new Date(+y + 60 * w * 1e3)
              if (
                ((D = new Date(
                  D.valueOf() +
                    1e3 * (D.getTimezoneOffset() - y.getTimezoneOffset()) * 60,
                )),
                (E = new Date(
                  E.valueOf() +
                    1e3 * (E.getTimezoneOffset() - y.getTimezoneOffset()) * 60,
                )),
                i < E && r > D)
              ) {
                var S = e._get_block_by_config(t)
                S.className = m
                var N = e._timeline_getX({ start_date: D }, !1, o) - 1,
                  M =
                    e._timeline_getX(
                      {
                        start_date: E,
      ...
      return k.apply(e, [t, a, n])
    }
    var D = e._append_mark_now
    e._append_mark_now = function (t, a) {
      ...
      return D.apply(e, [t, a])
    }
    var E = e._mark_timespans
    e._mark_timespans = function () {
      if (e.matrix && e.matrix[e.getState().mode]) {
        for (
          var t = [], a = e.matrix[e.getState().mode], n = a.y_unit, i = 0;
          i < n.length;
          i++
        ) {
          var r = n[i].key,
    ...
    ;(e._on_scale_add_marker = function (t, a) {
        ...
        if (i && e.matrix && e.matrix[e._mode])
          for (
            ...
            var l = +s,
              ...
              u = d[l] || d[c]
            if (
              (h.push.apply(h, e._get_configs_to_render(u)), i[r] && i[r][a])
            ) {
              var g = [],
      ...
      (e._get_date_index = function (e, t) {
        for (
          var a = e._trace_x, n = 0, i = a.length - 1, r = t.valueOf();
          i - n > 3;
      ...
      (e._timeline_drag_date = function (t, a) {
        ...
        if (n.round_position) {
          ...
          l && 'move' != l && 'create' != l && (s = 0.5), r >= s && d++, (r = 0)
        }
        ...
        if (d >= n._trace_x.length)
          (c = e.date.add(
            ...
            n._end_correction && (c = new Date(c - n._end_correction))
        else {
    ...
    var N = 10,
      M = null,
      A = null,
      C = e.attachEvent('onSchedulerReady', function () {
        e.matrix && (e.event(document.body, 'mousemove', g), e.detachEvent(C))
      })
    e._timeline_smart_render = {
      ...
      getVisibleHeader: function (t, a) {
        ...
        for (var i in t._h_cols) {
          var r = t._h_cols[i]
          if (
            this.isInXViewPort({ left: r.left, right: r.left + e._cols[i] }, a)
          ) {
            ;(n += r.div.outerHTML),
      ...
      updateHeader: function (t, a, n) {
        ...
        for (
          var i = e.$container.querySelectorAll('.dhx_cal_header > div'),
        ...
        if (this.getVisibleHeader(t, a)) {
          ...
          s.length &&
            ...
            d.length &&
              ((this._cols_to_add = d.slice()), this._addHeaderCells(d, t, n))
        }
      },
              ...
              this.isInYViewPort(
                {
                  ...
                  bottom:
                    e._label_rows[n].top + e._section_height[e.y_unit[n].key],
                },
                t,
              )
            ) {
      ...
      updateLabels: function (e, t, a) {
        ...
        if (
          ...
          r.length &&
            ...
            i.length &&
              ((this._rows_to_add = i.slice()), this._addLabelCells(i, e, a))
        }
      },
      ...
      _addLabelCells: function (e, t, a) {
        for (var n = '', i = 0; i < e.length; i++) n += t._label_rows[e[i]].div
        a.insertAdjacentHTML('beforeEnd', n)
      },
          ...
          if (o)
            for (var _ = 0, d = o.length; _ < d; _++) {
              ...
              n.$coordinates && n.$coordinates[h]
                ? ((s = n.$coordinates[h].xStart), (l = n.$coordinates[h].xEnd))
                : ((s = e._timeline_getX(c, !1, t)),
                  (l = e._timeline_getX(c, !0, t)),
                  n.$coordinates &&
                    (n.$coordinates[h] = { xStart: s, xEnd: l })),
                e._timeline_smart_render.isInXViewPort(
                  { left: s, right: l },
                  a,
                ) &&
      ...
      getVisibleRowCellsHTML: function (t, a, n, i, r) {
        for (
          ...
          ;(o = t._h_cols[l].left - t.dx),
            e._ignores[l]
              ? 'cell' == t.render
                ? (_ += e._timeline_get_html_for_cell_ignores(n))
                : (_ += e._timeline_get_html_for_bar_ignores())
              : 'cell' == t.render
              ? (_ += e._timeline_get_html_for_cell(l, r, t, i[r][l], n, o))
              : (_ += e._timeline_get_html_for_bar(l, r, t, i[r], o))
        }
        return _
      },
        ...
        if (i) {
          for (
            ...
            if (
              (l =
                'cell' == a.render
                  ? i.querySelector('[data-section-index="' + _ + '"]')
                  : i.querySelector(
                      '[data-section-index="' + _ + '"] .dhx_timeline_data_row',
                    ))
            ) {
      ...
      getVisibleGridCell: function (t, a, n, i, r, o) {
        if (t._h_cols[o]) {
          ...
          return (
            'cell' == t.render
              ? e._ignores[o] ||
                (_ += e._timeline_get_html_for_cell(o, r, t, i[r][o], n, d))
              : e._ignores[o] ||
                (_ += e._timeline_get_html_for_bar(o, r, t, i[r], d)),
            _
          )
        }
      },
