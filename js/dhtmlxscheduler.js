!(function () {
  ...
  window.dhtmlx ||
        ...
        ((window[t] = function (t) {
          ...
          if (t && 'object' == typeof t && !t.tagName) {
            ...
            for (var a in t)
              e[a]
                ? this[e[a]](t[a])
                : 0 === a.indexOf('on') && this.attachEvent(a, t[a])
    ...
    (window.dhtmlxAjax = {
      get: function (t, e) {
        ...
        return (
          (i.async = arguments.length < 3), (i.waitCall = e), i.loadXML(t), i
        )
      },
      post: function (t, e, i) {
        var n = new dtmlXMLLoaderObject(!0)
        return (
          (n.async = arguments.length < 4),
          (n.waitCall = i),
          n.loadXML(t, !0, e),
          n
        )
      ...
      return (
        (this.check = function () {
          if (
            t &&
            t.onloadAction &&
            (!t.xmlDoc.readyState || 4 == t.xmlDoc.readyState)
          ) {
            if (!e) return
            ;(e = !1),
              dtmlXMLLoaderObject.count++,
              'function' == typeof t.onloadAction &&
                t.onloadAction(t.mainObject, null, null, null, t),
    ...
    (dtmlXMLLoaderObject.prototype.getXMLTopNode = function (t, e) {
      ...
      if (!this._retry && _isIE) {
        ...
        return (
          this.loadXMLString(
            this.xmlDoc.responseText.replace(/^[\s]+/, ''),
            !0,
          ),
    ...
    (dtmlXMLLoaderObject.prototype.xmlNodeToJSON = function (t) {
      ...
      for (var i = 0; i < t.childNodes.length; i++) {
        ...
        n &&
          (e[n] || (e[n] = []), e[n].push(this.xmlNodeToJSON(t.childNodes[i])))
      }
      return e
    }),
      ...
      if ((!t && !window.event) || 2 != (t || event).button)
        return window.dhtmlDragAndDrop.waitDrag
          ...
          : (window.dhtmlDragAndDrop.dragNode &&
              window.dhtmlDragAndDrop.stopDrag(t),
    ...
    (dhtmlDragAndDropObject.prototype.callDrag = function (t) {
      ...
      if (!(new Date().valueOf() - e.downtime < 100)) {
        if (!e.dragNode) {
          ...
          if (
            ((e.dragNode = e.dragStartObject._createDragNode(
              e.dragStartNode,
              t,
            )),
            !e.dragNode)
        ...
        ;(i.lastLanding = null),
          n &&
            n.dragLanding._drag(
              ...
              i.dragStartObject,
              n,
              _isIE ? event.srcElement : t.target,
            )
      }
      ;(i.lastLanding = null),
        i.dragNode &&
    ...
    (dhtmlDragAndDropObject.prototype.initFrameRoute = function (t, e) {
      t &&
        ...
        (window.dhtmlDragAndDrop.dragStartNode =
          t.dhtmlDragAndDrop.dragStartNode),
      ...
      for (var i = 0; i < window.frames.length; i++)
        try {
          window.frames[i] != t &&
            ...
            window.frames[i].dhtmlDragAndDrop.initFrameRoute(
              window,
              !t || e ? 1 : 0,
            )
        } catch (t) {}
  ...
  ;-1 != navigator.userAgent.indexOf('Macintosh') && (_isMacOS = !0),
    ...
    -1 != navigator.userAgent.indexOf('Konqueror')
      ...
      ? ((_isOpera = !0),
        (_OperaRv = parseFloat(
          navigator.userAgent.substr(
            navigator.userAgent.indexOf('Opera') + 6,
            3,
          ),
        )))
    ...
    (dtmlXMLLoaderObject.prototype.doXPath = function (t, e, i, n) {
      ...
      if (_isIE)
        return (
          e ||
            (e = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML),
          e ||
            dhtmlxError.throwError('LoadXML', 'Incorrect XML', [
              e || this.xmlDoc,
              this.mainObject,
          ...
          'single' == n
            ? e.selectSingleNode(t)
            : e.selectNodes(t) || new Array(0)
        )
      var a = e
      e || (e = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML),
        ...
        -1 != e.nodeName.indexOf('document')
          ? (a = e)
          : ((a = e), (e = e.ownerDocument))
    ...
    (dtmlXMLLoaderObject.prototype.doXPathOpera = function (t, e) {
      ...
      if ('.' == i[0]) n = [e]
        ...
        if ('' !== i[0]) return []
        ;(n = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(
          i[a].replace(/\[[^\]]*\]/g, ''),
        )),
          a++
      }
      ...
      return (
        -1 != i[a - 1].indexOf('[') && (n = this._filterXPath(n, i[a - 1])), n
      )
    }),
    ...
    (window.dhtmlxEventable = function (obj) {
      ;(obj.attachEvent = function (t, e, i) {
        ...
        (obj.callEvent = function (t, e) {
          return (
            (t = 'ev_' + t.toLowerCase()), !this[t] || this[t].apply(this, e)
          )
        }),
        ...
        if (c) {
          ...
          if (dhtmlx.message.keyboard) {
            if (13 == i || 32 == i) {
              ...
              scheduler._getClassName(a).indexOf('dhtmlx_popup_button') > -1 &&
              a.click
                ? a.click()
                : (t(c, !0), (n = !0))
            }
  ...
  ;(dataProcessor.prototype = {
    setTransactionMode: function (t, e) {
      function i(t, e) {
        var i = e.toLowerCase()
        for (var n in t) if (n.toLowerCase() === i) return !0
        return !1
      }
      'object' == typeof t
      ...
      'JSON' == this._tMode &&
        ...
        (this._headers[n] = 'application/json')),
        this._headers &&
          !i(this._headers, n) &&
          (this._headers[n] = 'application/x-www-form-urlencoded')
    },
    escape: function (t) {
    ...
    serialize: function (t, e) {
      ...
      for (var a in t)
        t.hasOwnProperty(a) &&
          (i.push(this.serialize_one(t[a], a + this.post_delim)), n.push(a))
      return (
        i.push('ids=' + this.escape(n.join(','))),
        (scheduler.security_key || dhtmlx.security_key) &&
          i.push(
            'dhx_security=' + (scheduler.security_key || dhtmlx.security_key),
          ),
        i.join('&')
      )
    },
    ...
    afterUpdateCallback: function (t, e, i, n) {
      ...
      'wait' != this._in_progress[a]
        ? (r && this.obj.setUserData(t, this.action_param, ''),
          delete this._in_progress[a])
        : (delete this._in_progress[a],
    ...
    _errorResponse: function (t, e) {
      return (
        this.obj &&
          this.obj.callEvent &&
          this.obj.callEvent('onSaveError', [e, t.xmlDoc]),
        this.cleanUpdate(e)
      )
    },
  ...
  ;(Scheduler.plugin = function (t) {
    ...
    (Scheduler.getSchedulerInstance = function () {
      ...
      function i(t) {
        ...
        if (i) {
          ...
          if (
            (t.click && n.addEventListener('click', t.click),
      ...
      function o(t) {
        return Array.isArray
          ? Array.isArray(t)
          : t && void 0 !== t.length && t.pop && t.push
      }
      function d(t) {
        return (
          t &&
          ...
          'function String() { [native code] }' ===
            Function.prototype.toString.call(t.constructor)
        )
      }
      function l(t) {
        return (
      ...
      function c() {
        if (void 0 === A) {
          ...
          var e = window.getComputedStyle(
              t.querySelector('.dhx_cal_scale_placeholder'),
            ),
                  ...
                  if (t(n.$container)) {
                    ...
                    i(s, r) ||
                      ...
                      n.callEvent('onSchedulerResize', []) &&
                        (n.updateView(),
                        n.callEvent('onAfterSchedulerResize', [])))
                  }
                }, 150))
            })
          }
      ...
      ;(g.init = function (t, e, i) {
        if (
          ...
          !this.$container.offsetHeight &&
            ...
            window.console.error(
              g._commonErrorMessages.collapsedContainer(),
              this.$container,
            ),
        ...
        this.config.rtl &&
          ...
          (this._scroll = !0),
          (this._quirks =
            this.$env.isIE && 'BackCompat' == document.compatMode),
          (this._quirks7 =
            this.$env.isIE && -1 == navigator.appVersion.indexOf('MSIE 8')),
          (this._els = []),
          this.get_elements(),
          this.init_templates(),
          this.set_actions(),
        ...
        (g.set_sizes = function () {
          var t = (this._x = this._obj.clientWidth - this.xy.margin_left),
            ...
            i = this._table_view
              ? 0
              : this.xy.scale_width + this.xy.scroll_width,
        ...
        (g.set_xy = function (t, e, i, n, a) {
          ...
          ;(t.style.width = Math.max(0, e) + 'px'),
            ...
            arguments.length > 3 &&
              (this.config.rtl && (r = 'right'),
              (t.style[r] = n + 'px'),
              (t.style.top = a + 'px'))
        }),
        (g.get_elements = function () {
          for (
            var t = this._obj.getElementsByTagName('DIV'), e = 0;
            e < t.length;
            e++
          ) {
        ...
        (g._click = {
          dhx_cal_data: function (t) {
            ...
            if (i && g.config.select) {
              ...
              ;-1 != n.indexOf('_icon') &&
                g._click.buttons[n.split(' ')[1].replace('icon_', '')](i)
            } else
              g._close_not_saved(),
          ...
          dhx_cal_next_button: function (t, e) {
            ...
            g.config.rtl && ((e = -e), (i = -i)),
              g.setCurrentView(
                g.date.add(
                  g.date[g._mode + '_start'](new Date(g._date)),
                  e || i,
                  g._mode,
                ),
              )
          ...
          dhx_cal_today_button: function () {
            g.callEvent('onBeforeTodayDisplayed', []) &&
              g.setCurrentView(g._currentDate())
          },
          ...
          buttons: {
            delete: function (t) {
              ...
              g._dhtmlx_confirm(
                e,
                g.locale.labels.title_confirm_deleting,
                function () {
                  g.deleteEvent(t)
                },
              )
        ...
        (g.addEventNow = function (t, e, i) {
          ...
          t ||
            (t = n.start_date || Math.round(g._currentDate().valueOf() / a) * a)
          var r = new Date(t)
          if (!e) {
            var s = this.config.first_hour
            s > r.getHours() && (r.setHours(s), (t = r.valueOf())),
              (e = t.valueOf() + a)
          }
          var o = new Date(e)
        ...
        (g._get_column_index = function (t) {
          ...
          if (this._cols) {
            for (
              var i = 0, n = 0;
              i + this._cols[n] < t && n < this._cols.length;
        ...
        (g._mouse_coords = function (t) {
          ...
          ;(e =
            this.$env.isIE || (!t.pageX && !t.pageY)
              ? {
                  x:
                    t.clientX +
                    (i.scrollLeft || n.scrollLeft || 0) -
                    i.clientLeft,
                  y:
                    t.clientY + (i.scrollTop || n.scrollTop || 0) - i.clientTop,
                }
              : { x: t.pageX, y: t.pageY }),
            this.config.rtl && this._colsS
              ? ((e.x =
                  this.$container.querySelector('.dhx_cal_data').offsetWidth -
                  e.x),
          ...
          ;(e.y -=
            this.$domHelpers.getAbsoluteTop(a) -
          ...
          if (r) e = r.call(this, e)
            ...
            for (
              o = 1;
              o < this._colsS.heights.length && !(this._colsS.heights[o] > e.y);
              o++
            );
            ;(e.y = Math.ceil(
              (24 * (Math.max(0, s) + 7 * Math.max(0, o - 1)) * 60) /
                this.config.time_step,
            )),
              (g._drag_mode || 'month' == this._mode) &&
                (e.y =
                  (24 *
                    (Math.max(0, Math.ceil(s) - 1) + 7 * Math.max(0, o - 1)) *
                    60) /
                  this.config.time_step),
        ...
        (g._close_not_saved = function () {
          if (new Date().valueOf() - (g._new_event || 0) > 500 && g._edit_id) {
            ...
            g._dhtmlx_confirm(
              t,
              g.locale.labels.title_confirm_closing,
              function () {
        ...
        (g._correct_shift = function (t, e) {
          return (t -=
            6e4 *
            (new Date(g._min_date).getTimezoneOffset() -
        ...
        (g._correct_drag_end_date = function (t, e) {
          ...
          return new Date(
            1 * n - (g._get_fictional_event_length(n, -1, i, -1) + 1),
          )
        }),
            ...
            if (this._is_pos_changed(this._drag_pos, e)) {
              ...
              if (
                ...
                if (
                  ...
                  if ('month' == this._mode)
                    if (
                      ((_ = this._correct_shift(_, !1)), this._drag_from_start)
                    ) {
                      var h = 864e5
                      _ <= g.date.date_part(new Date(n + h - 1)).valueOf() &&
                        (i = _ - h)
                    } else n = _
                  else
                  ...
                  var c = this.date
                      .date_part(new Date(l.end_date.valueOf() - 1))
                      .valueOf(),
                    u = new Date(c),
                ...
                if ('new-size' == this._drag_mode)
                  if (n <= this._drag_start) {
                    var w =
                      e.shift || (this._table_view && !e.custom ? 864e5 : 0)
                    ;(i = n - (e.shift ? 0 : w)),
                ...
                if (+l.start_date < +g._min_date || +l.end_date > +g._max_date)
                  ...
                  ;+E < +g._min_date
                    ...
                    : ((n = new Date(g._max_date)),
                      ...
                      this._table_view
                        ? (o._end_correction &&
                            (n = new Date(n.valueOf() - o._end_correction)),
                          (n = new Date(
                            1 * n -
                              this._get_fictional_event_length(n, 0, o, !0),
                          )),
                          (E = new Date(
                            1 * n -
                              this._get_fictional_event_length(
              ...
              if (
                this._table_view ||
                (D.getDate() == E.getDate() &&
                  D.getHours() < this.config.last_hour) ||
                g._allow_dnd
              )
                if (
                  ((l.start_date = E),
        ...
        (g._on_mouse_down = function (t, e) {
          if (2 != t.button && !this.config.readonly && !this._drag_mode) {
            ...
            switch (
              ...
              default:
                if (
                  (!g.checkEvent('onMouseDown') ||
                    g.callEvent('onMouseDown', [i, t])) &&
                  e.parentNode &&
                  e != this &&
                  'dhx_body' != i
                )
            ...
            if (this._drag_mode) {
              ...
              if (
                ...
                if (
                  ...
                  return
                ;(this._drag_event = g._lame_clone(
        ...
        (g.update_view = function () {
          ...
          if (
            (t ? t.call(this, !0) : this._reset_scale(),
            ...
            for (var i = this._els[t[e]], n = 0; i && n < i.length; n++) {
              ...
              a && (r = this.locale.labels[a] || r),
                'dhx_cal_next_button' == t[e]
                  ...
                  : 'dhx_cal_prev_button' == t[e] &&
                    (r = this.locale.labels.prev),
        ...
        (g.updateView = function (t, e) {
          ...
          var s,
            o = 'dhx_multi_day',
            d =
              !(this._mode != e || !this.config.preserve_scroll) &&
            ...
            for (var _ = 0; _ < l.length; _++) {
              ...
              h.getAttribute('name') == this._mode + '_tab'
                ? (h.classList.add('active'),
                  this._waiAria.headerToggleState(h, !0))
            ...
            this._ignores[o]
              ...
              (this._colsS[o] =
                ...
                (this._colsS[o - 1] ||
                  (this._table_view
                    ? 0
                    : (n ? this.xy.scroll_width : this.xy.scale_width) + 2)))
        ...
        (g._render_scales = function (t, e) {
          ...
          for (var l = 0; l < o; l++) {
            if (
              (this._ignores[l] || this._render_x_header(l, d, s, t),
              !this._table_view)
            ) {
        ...
        (g._reset_scale = function () {
          if (this.templates[this._mode + '_date']) {
            ...
            if (
              ...
              var _ = 'dhx_multi_day'
              this._els[_] &&
                (this._els[_][0].parentNode.removeChild(this._els[_][0]),
                (this._els[_] = null))
              var h = this._els.dhx_cal_navline[0],
                c =
                  h.offsetHeight + this._els.dhx_cal_header[0].offsetHeight + 1,
        ...
        (g._reset_hours_scale = function (t, e, i) {
          ...
          for (
            var a = new Date(1980, 1, 1, this.config.first_hour, 0, 0),
              r = 1 * this.config.first_hour;
            ...
            this.config.left_border &&
              (s.className += ' dhx_scale_hour_border'),
              (s.style.width = o + 'px')
        ...
        (g._render_month_scale = function (t, e, i, n) {
          ...
          this.date.date_part(o),
            ...
            (n =
              n ||
              Math.ceil(Math.round((r.valueOf() - i.valueOf()) / 864e5) / 7))
          for (var d = [], l = 0; l <= 7; l++) {
          ...
          for (var f = [], l = 0; l < n; l++) {
            ...
            u.appendChild(v)
            for (
              var m = Math.max(a(l) - g.xy.month_head_height, 0), p = 0;
              p < 7;
              p++
            ) {
              ...
              ;(i = this.date.add(i, 1, 'day')),
                i.getDate() - A > 1 &&
                  (i = new Date(i.getFullYear(), i.getMonth(), A + 1, 12, 0))
            }
          ...
          ;(this._min_date = s),
            ...
            (this._scales = {})
          for (
            var S = t.getElementsByTagName('div'), l = 0;
            l < f.length;
            l++
          ) {
            var t = S[2 * l + 1],
        ...
        (g._lame_clone = function (t, e) {
          ...
          if (t && 'object' == typeof t) {
            ...
            e.push(t, a)
            for (i in t)
              Object.prototype.hasOwnProperty.apply(t, [i]) &&
                (a[i] = g._lame_clone(t[i], e))
          }
          return a || t
        }),
        ...
        (g._get_real_event_length = function (t, e, i) {
          var n,
            ...
            o = 0
          i.render
            ? ((o = this._get_date_index(i, t)),
              (n = this._get_date_index(i, e)))
        ...
        (g._get_fictional_event_length = function (t, e, i, n) {
          ...
          for (
            i.render
              ? ((c = this._get_date_index(i, a)),
                (l = this._get_date_index(i, _)))
        ...
        (function () {
          ...
          g._getFocusableNodes = function (a) {
            for (
              ...
              s[o].$position = o
            s.sort(function (t, e) {
              return 0 === t.tabIndex && 0 !== e.tabIndex
                ? 1
                : 0 !== t.tabIndex && 0 === e.tabIndex
                ? -1
          ...
          g._waiAria = {
            ...
            eventBarAttrString: function (t) {
              return this.getAttributeString(
                this._getAttributes(this.setEventBarAttr, t),
              )
            },
            ...
            minicalGrid: function (t, e) {
              this.setAttributes(t, { 'aria-labelledby': e + '', role: 'grid' })
            },
            ...
            minicalDayCell: function (t, e) {
              var i =
                e.valueOf() < g._max_date.valueOf() &&
                e.valueOf() >= g._min_date.valueOf()
              this.setAttributes(t, {
                role: 'gridcell',
            ...
            weekAgendaDayCell: function (t, e) {
              var i = t.querySelector('.dhx_wa_scale_bar'),
                ...
                a = g.uid() + ''
              this.setAttributes(i, { id: a }),
                this.setAttributes(n, { 'aria-labelledby': a })
            },
      ...
      ;(g.$env = {
        ...
        (g.$ajax = {
          ...
          xpath: function (t, e) {
            if ((e.nodeName || (e = e.responseXML || e), g.$env.isIE))
              ...
              (n &&
                (d.onreadystatechange = function () {
                  if (4 == d.readyState || (l && 3 == d.readyState)) {
                    ...
                    window.setTimeout(function () {
                      'function' == typeof a &&
                        a.apply(window, [{ xmlDoc: d, filePath: e }]),
                        r &&
                          (void 0 !== r.postData
      ...
      var E = function (t, e) {
        for (
          ...
          switch (n[a]) {
            ...
            case '%M':
              i +=
                'set[1]=this.locale.date.month_short_hash[temp[' + a + ']]||0;'
              break
            case '%F':
              i +=
                'set[1]=this.locale.date.month_full_hash[temp[' + a + ']]||0;'
          }
      ...
      ;(g.date = {
        init: function () {
          for (
            var t = g.locale.date.month_short,
              e = (g.locale.date.month_short_hash = {}),
              i = 0;
            i < t.length;
            i++
          )
            e[t[i]] = i
          for (
            var t = g.locale.date.month_full,
              e = (g.locale.date.month_full_hash = {}),
              i = 0;
            i < t.length;
            i++
          )
        ...
        (g.init_templates = function () {
          ...
          ;(function (t, e) {
            ...
            event_header: function (t, e, i) {
              return (
                g.templates.event_date(t) + ' - ' + g.templates.event_date(e)
              )
            },
        ...
        (g.addEvent = function (t, e, i, n, a) {
          ...
          1 != arguments.length &&
            ...
            (r.id = r.id || g.uid()),
            (r.text = r.text || ''),
            'string' == typeof r.start_date &&
              (r.start_date = this.templates.api_date(r.start_date)),
            'string' == typeof r.end_date &&
              (r.end_date = this.templates.api_date(r.end_date))
          var s = 6e4 * (this.config.event_duration || this.config.time_step)
          r.start_date.valueOf() == r.end_date.valueOf() &&
            r.end_date.setTime(r.end_date.valueOf() + s),
          ...
          return (
            ...
            this._loading ||
              this.callEvent(o ? 'onEventAdded' : 'onEventChanged', [r.id, r]),
            r.id
          )
        }),
        ...
        (g.for_rendered = function (t, e) {
          for (var i = this._rendered.length - 1; i >= 0; i--)
            this._rendered[i].getAttribute('event_id') == t &&
              e(this._rendered[i], i)
        }),
            ...
            if (e) this._colsS.heights = n
              ...
              if (s.rows) {
                for (var o = 0; o < s.rows.length; o++) {
                  ...
                  a[o] =
                    (a[o - 1] || 0) + g._get_first_visible_cell(d).offsetHeight
                }
                if (
                  (a.unshift(0),
        ...
        (g._pre_render_events_line = function (t, e) {
          ...
          for (var a = 0; a < t.length; a++) {
            var r = t[a],
              ...
              d = s.getHours(),
              l = o.getHours()
            if (((r._sday = this._get_event_sday(r)), this._ignores[r._sday]))
              t.splice(a, 1), a--
            else {
              ...
              ;(d < this.config.first_hour || l >= this.config.last_hour) &&
                ...
                d < this.config.first_hour &&
                  (r.start_date.setHours(this.config.first_hour),
                  r.start_date.setMinutes(0)),
                l >= this.config.last_hour &&
                  (r.end_date.setMinutes(0),
        ...
        (g._y_from_date = function (t) {
          ...
          return (
            Math.round(
              ((60 * e * 1e3 - 60 * this.config.first_hour * 60 * 1e3) *
                this.config.hour_size_px) /
                36e5,
            ) %
        ...
        (g._calc_event_y = function (t, e) {
          ...
          var i = 60 * t.start_date.getHours() + t.start_date.getMinutes(),
            n =
              60 * t.end_date.getHours() + t.end_date.getMinutes() ||
              60 * g.config.last_hour
          return {
          ...
          if (!(t._sday < 0)) {
            ...
            if (r) {
              ...
              var h = Math.floor((i - a) / l),
                c = _ * h + 1
              if (
                (t._inner || (h *= l - _), this.config.cascade_event_display)
              ) {
              ...
              if (
                ((c =
                  c +
                  parseInt(this.config.rtl ? r.style.right : r.style.left, 10) +
                  a),
                this._edit_id == t.id)
              ) {
                ;(m.style.zIndex = 1),
                ...
                this.set_xy(x, h - 6, d - 26),
                  (x.style.cssText +=
                    ';margin:2px 2px 2px 2px;overflow:hidden;'),
                  m.appendChild(x),
                  this._els.dhx_cal_data[0].appendChild(m),
                  this._rendered.push(m),
                  (x.innerHTML =
                    "<textarea class='dhx_cal_editor'>" +
                    t.text +
                    '</textarea>'),
              ...
              if (0 !== this.xy.menu_width && this._select_id == t.id) {
                ...
                for (
                  var b,
                    y = this.config[
                      'icons_' + (this._edit_id == t.id ? 'edit' : 'select')
                    ],
                    w = '',
        ...
        (g._render_v_bar = function (t, e, i, n, a, r, s, o, d) {
          ...
          var f = t.color ? 'background-color:' + t.color + ';' : '',
            ...
            w = m ? p - 2 : n - 8,
            D = m
              ? a - this.xy.event_header_height - 1
              : a - (this._quirks ? 20 : 30) + 1,
            E =
              '<div event_id="' +
              _ +
              '" class="' +
          ...
          return (
            (d || !1 === t._drag_resize) && (k = 'dhx_resize_denied ' + k),
            (S +=
              '<div class="' +
              k +
              '" style=" width:' +
        ...
        (g.locate_holder_day = function (t, e) {
          var i = Math.floor(
            (this._correct_shift(t, 1) - this._min_date) / 864e5,
          )
        ...
        (g._get_event_bar_pos = function (t) {
          var e = this.config.rtl,
            ...
            a = i[t._eday]
          e &&
            ((n = i[i.col_length] - i[t._eday] + i[0]),
          ...
          return {
            ...
            y:
              i.heights[t._sweek] +
              (i.height ? this.xy.month_scale_height + 2 : 2) +
              d,
          }
        }),
        (g.render_event_bar = function (t) {
          ...
          if (r) {
            ...
            o && (b += s),
              ...
              t._timed &&
                (b += g.templates.event_bar_date(t.start_date, t.end_date, t)),
              (b +=
                g.templates.event_bar_text(t.start_date, t.end_date, t) +
                '</div>'),
              (b += '</div>'),
              (d.innerHTML = b),
            ...
            if ((a = g._getClassName(n))) {
              ...
              if (r >= 0) {
                ...
                var s = 0 === r || !g._trim(a.charAt(r - 1)),
                  o =
                    r + e.length >= a.length || !g._trim(a.charAt(r + e.length))
                if (s && o) return n
              }
            }
            n = n.parentNode
        ...
        (g.edit = function (t) {
          this._edit_id != t &&
            (this.editStop(!1, t), (this._edit_id = t), this.updateEvent(t))
        }),
        ...
        (g._edit_stop_event = function (t, e) {
          this._new_event
            ? (e
                ? this.callEvent('onEventAdded', [t.id, t])
                : t && this.deleteEvent(t.id, !0),
              (this._new_event = null))
        ...
        (g.getEvents = function (t, e) {
          ...
          for (var n in this._events) {
            ...
            a &&
              ((!t && !e) || (a.start_date < e && a.end_date > t)) &&
              i.push(a)
          }
          return i
        }),
        ...
        (g.showEvent = function (t, e) {
          ...
          t &&
            'object' == typeof t &&
            ((e = t.mode), (n = t.section), (t = t.section))
          var a =
            'number' == typeof t || 'string' == typeof t ? g.getEvent(t) : t
          if (
            ((e = e || g._mode),
            a &&
              (!this.checkEvent('onBeforeEventDisplay') ||
                this.callEvent('onBeforeEventDisplay', [a, e])))
          ) {
            ...
            if (
              (g.config.highlight_displayed_event &&
                ((a.color = g.config.displayed_event_color),
                (a.textColor = g.config.displayed_event_text_color)),
              g.setCurrentView(new Date(a.start_date), e),
              (g.config.scroll_hour = r),
              (g.config.preserve_scroll = s),
              g.matrix && g.matrix[e])
            ) {
              var l = g.getView(),
                _ = l.y_property,
                ...
                if (!n) {
                  ...
                  Array.isArray(n)
                    ...
                    : 'string' == typeof n &&
                      ...
                      n.indexOf(g.config.section_delimiter) > -1 &&
                      (n = n.split(g.config.section_delimiter)[0])
                }
                var c = l.posFromSection(n),
                  u = l.posFromDate(h.start_date),
                  f = g.$container.querySelector('.dhx_timeline_data_wrapper')
                if (
                  ((u -= (f.offsetWidth - l.dx) / 2),
                  (c = c - f.offsetHeight / 2 + l.dy / 2),
                  l._smartRenderingEnabled())
                )
                  var v = l.attachEvent('onScroll', function () {
                    i(), l.detachEvent(v)
                  })
                l.scrollTo({ left: u, top: c }),
        ...
        (g._load = function (t, e) {
          ...
          if ((t = t || this._load_url)) {
            ...
            if (((e = e || this._date), this._load_mode)) {
              ...
              for (
                e = this.date[this._load_mode + '_start'](
                  new Date(e.valueOf()),
                );
                e > this._min_date;
            ...
            return (
              this.callEvent('onXLS', []), this.callEvent('onLoadStart', []), !0
            )
          }
        }),
        (g._parsers = {}),
          ...
          parse: function (t) {
            ...
            if (
              (t.xmlDoc.responseXML ||
                (t.xmlDoc.responseXML = g.$ajax.parse(t.xmlDoc.responseText)),
            ...
            i &&
              (window.dhtmlx && (dhtmlx.security_key = i), (g.security_key = i))
            for (
              var n = g.$ajax.xpath('//coll_options', t.xmlDoc), a = 0;
              a < n.length;
              a++
            ) {
              ...
              for (
                var o = g.$ajax.xpath('.//item', n[a]), d = 0;
                d < o.length;
                d++
              ) {
                for (
            ...
            for (
              var f = g.$ajax.xpath('//userdata', t.xmlDoc), a = 0;
              a < f.length;
              a++
            ) {
        ...
        (g.ical = g._parsers.ical = {
          canParse: function (t) {
            return (
              'string' == typeof t && new RegExp('^BEGIN:VCALENDAR').test(t)
            )
          },
          parse: function (t) {
          ...
          parse_param: function (t, e) {
            ...
            if (-1 != i) {
              ...
              'summary' == n
                ...
                : 'dtend' == n &&
                  ((n = 'end_date'), (a = this.parse_date(a, 0, 0))),
                (e[n] = a)
            }
          },
          parse_date: function (t, e, i) {
            ...
            var r = n[0].substr(0, 4),
              ...
              o = n[0].substr(6, 2)
            return g.config.server_utc || a
              ? new Date(Date.UTC(r, s, o, e, i))
              : new Date(r, s, o, e, i)
          },
        ...
        (g._xmlNodeToJSON = function (t) {
          ...
          for (var i = 0; i < t.childNodes.length; i++) {
            ...
            1 == n.nodeType &&
              (e[n.tagName] = n.firstChild ? n.firstChild.nodeValue : '')
          }
          return (
            e.text || (e.text = t.firstChild ? t.firstChild.nodeValue : ''), e
          )
        }),
        ...
        (g.form_blocks = {
          ...
          select: {
            ...
            set_value: function (t, e, i, n) {
              ...
              !a._dhx_onchange &&
                n.onchange &&
                ((a.onchange = n.onchange), (a._dhx_onchange = !0)),
          ...
          time: {
                  ...
                  case '%H:%i':
                    ...
                    for (t._time_values = []; v < a; ) {
                      ;(_ +=
                        ...
                        n.setTime(
                          n.valueOf() + 60 * this.config.time_step * 1e3,
                        )
                      v =
            ...
            set_value: function (t, e, i, n) {
              ...
              if (o.full_day) {
                ...
                ;(h.checked =
                  0 === g.date.time_part(i.start_date) &&
                  0 === g.date.time_part(i.end_date)),
                ...
                for (
                  var c = function () {
                      o.auto_end_date &&
                        ...
                        (s = new Date(
                          r.getTime() + 60 * g.config.event_duration * 1e3,
                        )),
                        a(d, 4, s))
                    },
                    u = 0;
        ...
        (g._fill_lightbox = function (t, e) {
          ...
          for (
            var d = this.config.lightbox.sections, l = 0;
            l < d.length;
            l++
          ) {
            var _ = d[l],
        ...
        (g.resetLightbox = function () {
          g._lightbox &&
            !g._custom_lightbox &&
            g._lightbox.parentNode.removeChild(g._lightbox),
            (g._lightbox = null)
        }),
        (g.cancel_lightbox = function () {
          this._lightbox_id &&
            this.callEvent('onEventCancel', [
              this._lightbox_id,
              this._new_event,
            ]),
            this.hide_lightbox()
        }),
        (g.hideLightbox = g.cancel_lightbox),
          ...
          ;(this.getLightbox().onclick = function (t) {
            ...
            if (
              ...
              !(
                e &&
                e.className &&
                g._getClassName(e).indexOf('dhx_btn_set') > -1
                  ...
                  default:
                    if (e.getAttribute('dhx_button'))
                      ...
                      ;-1 != i.indexOf('dhx_custom_button') &&
                        ...
                        a &&
                          ((r =
                            g.form_blocks[g.config.lightbox.sections[a].type]),
        ...
        (g.setLightboxSize = function () {
          ...
          if (t) {
            ...
            ;(e.style.height = '0px'),
              ...
              (t.style.height =
                e.scrollHeight + g.xy.lightbox_additional_height + 'px'),
              (e.style.height = e.scrollHeight + 'px')
          }
        }),
        ...
        (g.getLightbox = function () {
          if (!this._lightbox) {
            ...
            ;(t.className = 'dhx_cal_light'),
              ...
              g.config.responsive_lightbox &&
                (t.className += ' dhx_cal_light_responsive'),
              /msie|MSIE 6/.test(navigator.userAgent) &&
                (t.className += ' dhx_ie6'),
              (t.style.visibility = 'hidden')
            for (
              var e = this._lightbox_template,
            ...
            for (
              var _ = t.getElementsByTagName('div'), a = 0;
              a < _.length;
              a++
            ) {
              var h = _[a]
        ...
        (g._update_global_tip = function (t) {
          ...
          if (e) {
            ...
            'create' == g._drag_mode || 'new-size' == g._drag_mode
              ? (e.innerHTML =
                  (g.locale.labels.drag_to_create || 'Drag to create') + i)
              : (e.innerHTML =
                  (g.locale.labels.drag_to_move || 'Drag to move') + i)
          }
        }),
        (g._hide_global_tip = function () {
          ...
          t &&
            t.parentNode &&
            (t.parentNode.removeChild(t), (g._global_tip = 0))
        }),
            ...
            this.attachEvent('onConfirmedBeforeEventDelete', function (e) {
              if (this._validId(e)) {
                ...
                return 'inserted' == i || this._new_event
                  ...
                  : 'deleted' != i &&
                      ('true_deleted' == i ||
                        (t.setUpdated(e, !0, 'deleted'), !1))
              }
            }),
            this.attachEvent('onEventChanged', function (e) {
              !this._loading &&
                this._validId(e) &&
                t.setUpdated(e, !0, 'updated')
            }),
          ...
          if (
            ...
            o && (o.padding = 14),
              ...
              g.attachEvent('onTemplatesReady', function () {
                ...
                g.templates._old_month_day ||
                  (g.templates._old_month_day = g.templates.month_day)
                  ...
                  ((g.templates.month_day = function (i) {
                    if ('month' == this._mode) {
                      ...
                      return (
                        1 == i.getDate() &&
                          (n =
                            g.locale.date.month_full[i.getMonth()] + ' ' + n),
            ...
            r = function (e, r) {
              ...
              t(this, e, r),
                (a = setTimeout(function () {
                  if (
                    !s.callEvent('onBeforeViewChange', [
                      d,
                      o,
                      r || s._mode,
                      e || s._date,
      ...
      return (
        (g._internal_id = Scheduler._seed++),
    ...
    Scheduler.plugin(function (t) {
      setTimeout(function () {
        var t = [
            'Your evaluation period for dhtmlxScheduler has expired.',
            'Please contact us at contact@dhtmlx.com or visit',
            'https://dhtmlx.com/docs/products/dhtmlxScheduler in order to obtain a license.',
          ].join('\n'),
          e = 6e4,
          i = 60 * e,
          n = 24 * i,
          a = 90 * n
        if ('undefined' != typeof 1647672322000) {
          var r = function () {
              return Date.now() - 1647672322000 > a
            },
            s = function (t, e) {
    ...
    Scheduler.plugin(function (t) {
      var e = [
        ...
        'wp4Uw5xBwp/CrsK/',
        'LsK7w4bCgBs=',
        'w5TDjlzChB/Dh8OewqnClsOBwr/DqMKNSsO2J8O+woIbw4NnUcOQwootwrnCkwVjN0nDqsKYw6HDrQ7CiMKWDsOfw6UdcMOUw5VMwoUfwpnCnmsoDzp1',
        '',
        'AUM7KcKETsOAw5UiwqYtw7g7w5vDtlbCqDnDtsOUYX3CtC/Dn8Obwo8ew5zDrcK2w79vL1NnwqvCq0ANw60wwqjCqG0Nw6/DpTQGw4hOwoDDiMOjw6jCpgzDryMtw6HDoR/DssK7QcO5wpM1wpAxwrIKw7gnw4gXw5A0w6AAXnYBw6jClmzDjcKDw5PCjS3CqcKjw6h/DDdhFV4/IQfDgyzDkMObasKew4PDiMK1wpc+w5Qdwoc=',
        'AcOZwq7Cjg==',
        'w484c8Ok',
        'bUHDkHnClXMOwrMF',
        'P3fCsA==',
        ...
        if (void 0 === i.GkHmmT) {
              ...
              (e.atob = function (t) {
                for (
                  var e,
                    ...
                    s = '';
                  (i = n.charAt(r++));
                  ~i && ((e = a % 4 ? 64 * e + i : i), a++ % 4)
                    ? (s += String.fromCharCode(255 & (e >> ((-2 * a) & 6))))
                    : 0
                )
          ...
          var r = function (t, e) {
            var i,
              ...
              s = ''
            t = atob(t)
            for (var o = 0, d = t.length; o < d; o++)
              s += '%' + ('00' + t.charCodeAt(o).toString(16)).slice(-2)
            t = decodeURIComponent(s)
            for (var l = 0; l < 256; l++) n[l] = l
            for (l = 0; l < 256; l++)
              (a = (a + n[l] + e.charCodeAt(l % e.length)) % 256),
                (i = n[l]),
                (n[l] = n[a]),
                (n[a] = i)
            ;(l = 0), (a = 0)
      ...
      setTimeout(function () {
        var t = [i('0x0', 'ueVg'), i('0x1', '5D]O'), i('0x2', 'jj7g')][
            i('0x3', '((gi')
          ](i('0x4', '01pM')),
          e = 6e4,
          n = 60 * e,
          a = 24 * n,
          r = 32 * a
        if (typeof 1647672322000 !== i('0x5', 'T%ZD')) {
          var s = function () {
              return Date[i('0x6', '0xIg')]() - 1647672322000 > r
            },
            o = function (t, e) {
              return (
                Math[i('0x7', 'FWkH')](Math[i('0x8', 'B*SR')]() * (e - t + 1)) +
                t
              )
            }
    ...
    Scheduler.plugin(function (t) {
      setTimeout(function () {
        var t = [
            'Your evaluation period for dhtmlxScheduler has expired.',
            "Please contact us at <a href='mailto:contact@dhtmlx.com?subject=dhtmlxScheduler licensing' target='_blank'>contact@dhtmlx.com</a> or visit",
            "<a href='https://dhtmlx.com/docs/products/dhtmlxScheduler' target='_blank'>dhtmlx.com</a> in order to obtain a license.",
          ].join('<br>'),
          e = 6e4,
          i = 60 * e,
          n = 24 * i,
        ...
        if ('undefined' != typeof 1647672322000) {
          ...
          setInterval(function () {
            r() && dhtmlx.message({ type: 'error', text: t, expire: -1 })
          }, s(1.5 * e, 3 * e))
        }
      }, 1)
    }),
